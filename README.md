...
### YooChoose
```
nohup python -u DreamMiss.py --data yc --timesteps 2000 --lr 0.0001 --beta_sche linear --w 4 --cuda 7 --optimizer adamw --diffuser_type mlp1 --random_seed 100 >> log/dreammiss_yc.log 2>&1 &
```
### KuaiRec
